...
| gen-nanobanana-images | Google Gemini の画像生成モデル Nano Banana シリーズ GA 版（Flash2 / Pro / Nano Banana 2 Lite）で、Interactions API 基盤のテキストからの画像生成・画像編集・スタイルリファレンス・マルチターン反復修正を行う。要 `GEMINI_API_KEY`・SDK >= 2.11.0 | [docs/gen-nanobanana-images.md](docs/gen-nanobanana-images.md) |
